...
/*   Updated: 2018/02/08 15:34:46 by tbleuse          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_modif_minus(char **str, int **info, int mode)
{
	char	*tmp;
...
static int	ft_printf_di_second(char **str, int *info)
{
	...
	count = 0;
	if (info[1] != -1 && info[0] == 2)
		count += ft_modif_minus(NULL, &info, 2);
